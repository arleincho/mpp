...
public class Main {
	...
	public static <T, D> boolean contains22(List<D> list, D e, 
			BiPredicate<D, D> pred2) {
		
		System.out.println("afdsfsdf");
		for(D emp: list) {
			if(emp == null && e == null) return true;
			if(emp == null || e == null) continue;
			if(pred2.test(emp, e)) return true;
...
//		boolean result1 = Main.contains3(list, "Tom");
	...
	public static void test2() {
		...
		Employee e = new Employee(1001, "Joe44", 50000);
		boolean foundIt = Main.contains22(list, e, (e1,e2) -> e1.getId() == e2.getId());
...
//		boolean foundIt = Main.contains22(list, m, 
